            ...
            if self.interval_seq == None:
                ...
                if getattr(self.args, 'siec_return_trace', False):
                    ...
                    xs_list, x0_preds_list, trace = adaptive_generalized_steps_trace(
                        ...
                        score_source=getattr(self.args, 'score_source', 'syndrome'),
                        oracle_scores=getattr(self.args, 'oracle_scores', None),
                        oracle_topk_mask=getattr(self.args, 'oracle_topk_mask', None),
                    )
